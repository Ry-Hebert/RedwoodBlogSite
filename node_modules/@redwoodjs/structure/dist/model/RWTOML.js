...
let RWTOML = (_dec = (0, _decorators.lazy)(), (_class = class RWTOML extends _ide.FileNode {
  ...
  *diagnostics() {
    ...
    const allowedTopElements = ['web', 'api']; // TODO: check that schema is correct
  }

}, ((0, _applyDecoratedDescriptor2.default)(_class.prototype, "parsedTOML", [_dec], (0, _getOwnPropertyDescriptor.default)(_class.prototype, "parsedTOML"), _class.prototype)), _class));
