...
function _router(project) {
  ...
  return {
    ...
    menu: {
      kind: 'group',
      doc: (0, _vscode.Command_open)(`${DOCS}/redwood-router`),
...
function _functions(project) {
  return {
    ...
    menu: {
      ...
      doc: (0, _vscode.Command_open)(`${DOCS}/serverless-functions`)
    }
  };
}
...
const DOCS = 'https://redwoodjs.com/docs'; // TODO: add link to docs https://redwoodjs.com/docs/serverless-functions
