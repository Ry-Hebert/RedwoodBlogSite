...
const rwPackages = '@redwoodjs/core @redwoodjs/api @redwoodjs/web @redwoodjs/router @redwoodjs/auth @redwoodjs/forms'; // yarn upgrade-interactive does not allow --tags, so we resort to this mess
