...
export declare type GetCurrentUser = (decoded: AuthContextPayload[0], raw: AuthContextPayload[1]) => Promise<null | object | string>;
/**
 ...
 * ```
 */
export declare const createGraphQLHandler: ({ context, getCurrentUser, onException, ...options }?: GraphQLHandlerOptions, db?: any) => (event: APIGatewayProxyEvent, context: LambdaContext, callback: any) => void;
export {};
