...
const engines = [];
class NodeEngine {
    constructor({ cwd, datamodelPath, prismaPath, generator, datasources, showColors, logLevel, logQueries, env, flags, clientVersion, enableExperimental, engineEndpoint, enableDebugLogs, enableEngineDebugMode, }) {
        var _a;
        this.restartCount = 0;
...
Please look into the logs or turn on the env var DEBUG=* to debug the constantly restarting query engine.`);
        ...
        this.enableExperimental = this.enableExperimental.filter((e) => e !== 'middlewares');
